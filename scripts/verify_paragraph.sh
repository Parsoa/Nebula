...
intersect ./Paragraph/DEL/paragraph.bed merge.DEL.bed > paragraph.DEL.shared.bed
intersect ./Paragraph/INS/paragraph.bed merge.INS.bed > paragraph.INS.shared.bed
