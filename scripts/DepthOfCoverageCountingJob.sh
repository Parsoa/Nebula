...
echo $JLY
echo $@
python -m kmer.genotyping --job DepthOfCoverageCountingJob --bed /share/hormozdiarilab/Codes/NebulousSerendipity/data/$BED --exons /share/hormozdiarilab/Codes/NebulousSerendipity/data/$EXN --threads 48 --fastq "$P/../Simulation/test.fq" --reference $REF $SIM "$@"
