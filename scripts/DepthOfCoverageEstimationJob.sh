...
echo $JLY
echo $@
python -m kmer.depth --job ExonDepthOfCoverageEstimationJob --bed /share/hormozdiarilab/Codes/NebulousSerendipity/data/$BED --exons /share/hormozdiarilab/Codes/NebulousSerendipity/data/$EXN --threads 48 --jellyfish $JLY --fastq $GEN --reference $REF $SIM "$@"
