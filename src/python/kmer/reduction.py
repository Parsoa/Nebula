...
class ExtractLociIndicatorKmersJob(map_reduce.Job):
    ...
    def transform(self, track, track_name):
        ...
        _inner_kmers = sv.get_inner_kmers(counter = self.reference_counts_provider.get_kmer_count, count = 20, n = 1000)
        ...
        with open(os.path.join(self.get_previous_job_directory(), track), 'r') as json_file:
            ...
            for kmer in inner_kmers.keys():
                ...
                if k and track_name in k['tracks']:
                    if inner_kmers[kmer]['reference'] > 10:
                    ...
                    self.inner_kmers[kmer]['type'] = 'non_unique_inner'
                    ...
                    self.inner_kmers[kmer]['tracks'] = inner_kmers[kmer]['tracks']
                else:
                    inner_kmers.pop(kmer, None)
            if not inner_kmers: 
